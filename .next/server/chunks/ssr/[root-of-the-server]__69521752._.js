...
`,_=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=H(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(Z,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?$:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(Y,{toast:d,position:j}))}))};a.s(["CheckmarkIcon",()=>Q,"ErrorIcon",()=>L,"LoaderIcon",()=>N,"ToastBar",()=>Y,"ToastIcon",()=>V,"Toaster",()=>_,"default",()=>F,"resolveValue",()=>s,"toast",()=>F,"useToaster",()=>H,"useToasterStore",()=>D],6704)},15276,a=>{"use strict";let b=(a,b)=>{},c=()=>((a,b=null)=>b)(0,[]),d=()=>((a,b=null)=>b)(0,[]);a.s(["getAddresses",0,d,"getMessages",0,()=>((a,b=null)=>b)(0,[]),"getOrders",0,c,"saveAddress",0,a=>{let c=d();return c.push({...a,id:Date.now().toString()}),b("iclone_addresses",c),c},"saveOrder",0,a=>{let d=c();return d.push({...a,id:Date.now().toString(),createdAt:new Date().toISOString()}),b("iclone_orders",d),d},"saveToStorage",0,b])},21703,a=>{"use strict";var b=a.i(3888);let c=a=>{},d=(0,b.createSlice)({name:"cart",initialState:{total:0,cartItems:{}},reducers:{addToCart:(a,b)=>{let{productId:d}=b.payload;a.cartItems[d]?a.cartItems[d]++:a.cartItems[d]=1,a.total+=1,c(a)},removeFromCart:(a,b)=>{let{productId:d}=b.payload;a.cartItems[d]&&(a.cartItems[d]--,0===a.cartItems[d]&&delete a.cartItems[d]),a.total-=1,c(a)},deleteItemFromCart:(a,b)=>{let{productId:d}=b.payload;a.total-=a.cartItems[d]?a.cartItems[d]:0,delete a.cartItems[d],c(a)},clearCart:a=>{a.cartItems={},a.total=0,c(a)}}}),{addToCart:e,removeFromCart:f,clearCart:g,deleteItemFromCart:h}=d.actions,i=d.reducer;a.s(["addToCart",0,e,"clearCart",0,g,"default",0,i,"deleteItemFromCart",0,h,"removeFromCart",0,f])},45237,a=>{"use strict";var b=a.i(3888);let c=a=>{},d=(0,b.createAsyncThunk)("product/fetchProducts",async()=>{let a=await fetch("/api/products");return await a.json()}),e=(0,b.createSlice)({name:"product",initialState:{list:[],loading:!1,error:null},reducers:{setProduct:(a,b)=>{a.list=b.payload,c(a.list)},clearProduct:a=>{a.list=[],c(a.list)},addProduct:(a,b)=>{a.list.push(b.payload),c(a.list)},updateProduct:(a,b)=>{let d=a.list.findIndex(a=>a.id===b.payload.id);-1!==d&&(a.list[d]=b.payload,c(a.list))},deleteProduct:(a,b)=>{a.list=a.list.filter(a=>a.id!==b.payload),c(a.list)}},extraReducers:a=>{a.addCase(d.pending,a=>{a.loading=!0,a.error=null}).addCase(d.fulfilled,(a,b)=>{a.loading=!1,a.list=b.payload,c(a.list)}).addCase(d.rejected,(a,b)=>{a.loading=!1,a.error=b.error.message})}}),{setProduct:f,clearProduct:g,addProduct:h,updateProduct:i,deleteProduct:j}=e.actions,k=e.reducer;a.s(["addProduct",0,h,"default",0,k,"fetchProducts",0,d])},63659,a=>{"use strict";var b=a.i(3888),c=a.i(15276);let d=(0,b.createSlice)({name:"orders",initialState:{list:(0,c.getOrders)(),loading:!1,error:null},reducers:{addOrder:(a,b)=>{a.list=(0,c.saveOrder)(b.payload)},clearOrders:a=>{a.list=[],localStorage.removeItem("iclone_orders")},setOrders:(a,b)=>{a.list=b.payload}}}),{addOrder:e,clearOrders:f,setOrders:g}=d.actions,h=d.reducer;a.s(["addOrder",0,e,"default",0,h])},1531,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(14174),e=a.i(3888),f=a.i(21703),g=a.i(45237),h=a.i(15276);let i=(0,e.createSlice)({name:"address",initialState:{list:(0,h.getAddresses)()},reducers:{addAddress:(a,b)=>{a.list=(0,h.saveAddress)(b.payload)}}}),{addAddress:j}=i.actions,k=i.reducer,l=(0,e.createSlice)({name:"rating",initialState:{ratings:[]},reducers:{addRating:(a,b)=>{a.ratings.push(b.payload)}}}),{addRating:m}=l.actions,n=l.reducer;var o=a.i(63659);function p({children:a}){let h=(0,c.useRef)(void 0);return h.current||(h.current=(0,e.configureStore)({reducer:{cart:f.default,product:g.default,address:k,rating:n,orders:o.default}})),(0,b.jsx)(d.Provider,{store:h.current,children:a})}a.s(["default",()=>p],1531)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__69521752._.js.map